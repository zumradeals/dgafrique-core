...
final class NotificationHttpSmokeTest extends TestCase
{
    ...
    public function test_pending_mission_invitation_is_visible_on_the_notifications_page(): void
    {
        ...
        $project = app(\App\Application\Projects\ProjectService::class)->create('IDN-OWNER-HTTP', $this->projectPayload(), (new \App\Application\Projects\ProjectConfiguration)->defaults());
    ...
    {
        $this->get('/')->assertOk();
        self::assertSame(0, \App\Models\NotificationRead::query()->count());
    }
