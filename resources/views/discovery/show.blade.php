<x-layouts.portal title="Profil utile — DG Afrique">
    ...
    <div class="discovery-page">
        ...
        <main class="discovery-content person-detail">
            ...
            <div class="discovery-privacy"><strong>Une rencontre doit rester consentie.</strong><span>La messagerie et la demande de mise en relation seront ouvertes par un lot dédié. Aucune coordonnée privée n’est exposée ici.</span></div>
        </main>
    </div>
</x-layouts.portal>
