{{--
    Mémoire d'expérience — CAP-035, fiche §3, harmonisée UX-HARMONY-TRANSMISSIONS-PROOFS-001.
    Pas un second modèle métier : une vue chronologique agrégée des preuves accessibles de la
    personne, rien de plus.
--}}
    ...
    <x-dg.shell :identity="$identity" :is-administrator="$isAdministrator">
        <div class="pf-page">
            ...
            <section class="pf-dash-hero">
                <div class="pf-tags"><span>Mémoire d’expérience</span></div>
                <h1>{{ $isOwnMemory ? 'Ma mémoire d’expérience' : 'Mémoire d’expérience — '.$ownerLabel }}</h1>
            ...
            @else
                <div style="display:flex;flex-direction:column;gap:14px;max-width:760px;margin-top:20px">
