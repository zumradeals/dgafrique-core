<x-layouts.portal title="Confirmation du paiement — DG Afrique">
    <div class="membership-shell"><header class="membership-topbar"><a href="{{ route('zumra.membership.show') }}">← Adhésion</a><strong><i>Z</i> Programme ZUMRA</strong><a href="{{ route('member.space') }}">Mon espace</a></header>
