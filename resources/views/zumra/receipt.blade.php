<x-layouts.portal title="Reçu d’adhésion — DG Afrique">
    <div class="membership-shell"><header class="membership-topbar"><a href="{{ route('zumra.membership.show') }}">← Adhésion</a><strong><i>Z</i> Reçu d’adhésion</strong><button onclick="window.print()">Imprimer</button></header>
