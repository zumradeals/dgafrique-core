{{--
    Hub ZUMRA — ZUMRA-SPACE-001. Le carrefour de découverte, pas un dashboard personnel : la
    recherche par activité et l'exploration s'imposent visuellement en premier ; « Mes ZUMRA »,
    invitations et décisions restent importantes mais personnelles et secondaires.
        ...
        <div class="dg-page zumra-hub zumra-hub--v4">
            <section class="zumra-hub__hero" aria-labelledby="zumra-title">
                <div class="zumra-hub__hero-copy">
                    ...
                    <h1 id="zumra-title" class="dg-display zumra-hub__title">Le monde ZUMRA</h1>
                    <p class="zumra-hub__lead">
                        Une ZUMRA se reconnaît d’abord à son activité — ce qu’on y apprend, transmet et construit.
                        Cherchez une activité pour découvrir les collectifs qui la font vivre, ou proposez la vôtre.
                    </p>
                    <form method="GET" action="{{ route('zumra.groups.index') }}" class="zumra-hub__search" role="search">
                        <label for="zumra-search" class="sr-only">Rechercher une activité, un nom ou un objectif ZUMRA</label>
                        <input type="search" id="zumra-search" name="q" class="zumra-hub__search-input" placeholder="Couture, numérique, agriculture, transmission…" value="{{ $query ?? '' }}">
                        <button type="submit" class="zumra-hub__search-submit">Chercher</button>
                    </form>
                </div>

                <div class="zumra-hub__hero-panel" aria-label="Actions principales ZUMRA">
                    <div class="zumra-hub__hero-actions">
                        <a href="{{ route('zumra.groups.index') }}" class="zumra-hub__btn zumra-hub__btn--secondary">
                            <span aria-hidden="true">⌕</span>
                            Voir tous les collectifs
                        </a>

                        @if($membershipActive)
                            <a href="{{ route('zumra.groups.create') }}" class="zumra-hub__btn zumra-hub__btn--primary">
                                <span aria-hidden="true">＋</span>
                                Faire naître une ZUMRA
                            </a>
                        @else
                            <span class="zumra-hub__btn zumra-hub__btn--primary zumra-hub__btn--disabled" title="Réservé aux membres dont l’adhésion au Programme ZUMRA est active.">
                                <span aria-hidden="true">＋</span>
                                Faire naître une ZUMRA
                            </span>
                        @endif
            ...
            <section class="zumra-hub__discover zumra-hub__discover--top" aria-labelledby="discover-domain-title">
                <div class="zumra-hub__section-heading">
                    <div>
                        ...
                        <h2 id="discover-domain-title">Explorer par activité</h2>
                    </div>
                ...
                @if($discoverDomains->isNotEmpty())
                    <div class="zumra-hub__domain-grid {{ $discoverDomains->count() === 1 ? 'is-single' : '' }}">
                        @foreach($discoverDomains as $domain)
                            <a href="{{ route('zumra.groups.index', ['q' => $domain['domain']]) }}" class="zumra-hub__domain-card">
                                <span class="zumra-hub__domain-mark" aria-hidden="true">{{ mb_strtoupper(mb_substr($domain['domain'], 0, 1)) }}</span>
                                <div>
                                    <span class="zumra-hub__micro-label">Activité</span>
                                    <h3>{{ $domain['domain'] }}</h3>
                ...
                @else
                    <div class="zumra-hub__discover-empty">
                        Les activités apparaîtront ici à mesure que des ZUMRA seront réellement proposées.
                    </div>
                @endif
            </section>

            <div class="zumra-hub__personal">
                        ...
                        @empty
                            <div class="zumra-hub__empty">
                                ...
                                <div>
                                    ...
                                    <p>Cherchez une activité ci-dessus. Si votre adhésion est active, vous pouvez aussi faire naître une ZUMRA autour de la vôtre.</p>
                                </div>
                ...
                <aside class="zumra-hub__personal-side" aria-label="Votre suivi personnel">
