<x-layouts.portal title="Mes capacités — DG Afrique">
    ...
    <div class="space-shell progressive-profile">
        ...
        <div class="space-layout">
            <aside class="space-sidebar"><nav><a class="nav-blue" href="{{ route('member.space') }}">Vue d’ensemble</a><a class="active nav-cyan" href="{{ route('member.profile.edit') }}">Mes capacités</a><a class="nav-blue" href="{{ route('people.index') }}">Découvrir des personnes</a><span class="nav-amber">Mes besoins <small>à venir</small></span><span class="nav-blue">Opportunités <small>à venir</small></span><a class="nav-green" href="{{ route('zumra.index') }}">Mes ZUMRA <small>aperçu</small></a><span class="nav-amber">Mes projets <small>à venir</small></span><span class="nav-gray">Paramètres <small>à venir</small></span></nav></aside>
