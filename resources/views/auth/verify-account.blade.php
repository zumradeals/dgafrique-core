<x-layouts.portal title="Vérifier mon compte — DG Afrique">
    <main class="login-shell">
        <section class="login-story">
            ...
            <div class="login-promise"><p class="eyebrow">Dernière étape</p><h1>Vérifiez votre adresse.</h1><p>Le code est émis et livré directement par GAMAD Core. DG Afrique ne le conserve pas.</p></div>
        ...
        <section class="login-form-panel">
            <div class="login-form-wrap">
                ...
                <form method="POST" action="{{ route('register.verify.store') }}" class="auth-form">
                    @csrf
                    <label>Code GAMAD</label><input name="code" inputmode="numeric" pattern="[0-9]{6}" maxlength="6" required autocomplete="one-time-code" class="verification-code">
