...
final class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        RateLimiter::for('zahab-acquisition', static fn (Request $request): Limit => Limit::perMinute(6)->by($request->ip()));
        RateLimiter::for('zahab-acquisition-status', static fn (Request $request): Limit => Limit::perMinute(12)->by($request->ip()));
        ...
        RateLimiter::for('project-funding-contribution', static fn (Request $request): Limit => Limit::perMinute(6)->by($request->ip()));
